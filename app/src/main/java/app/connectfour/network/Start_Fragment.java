...
public class Start_Fragment extends Fragment implements OnBackPressed{
    ...
    //UI stuff
    Button btn_client, btn_server, btn_pair;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.bluetooth_select, container, false);
        logger = (TextView) myView.findViewById(R.id.logger1);


        btn_client = (Button) myView.findViewById(R.id.join);
        ...
        btn_server = (Button) myView.findViewById(R.id.create);
        ...
        btn_pair = (Button) myView.findViewById(R.id.pair);
    ...
    public void onBackPressed(){
        final int bluetoothMode = 4;
        Intent i = new Intent(getActivity(), Name.class);
